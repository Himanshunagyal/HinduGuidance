export const festivals = [
  {
    ...
    rituals: [
      ...
      "Light diyas in every room and outside the home",
      "Perform Lakshmi-Ganesha puja during Pradosh kaal",
      "Open all windows and doors during puja to welcome prosperity",
  ...
  },
  {
    ...
    rituals: [
      "Buy gold, silver coins, or new utensils — even small amounts are auspicious",
      "Buy a broom (jhadu) to sweep away poverty",
      "Light a diya facing south in the evening",
      "Worship Goddess Lakshmi and Lord Dhanvantari",
      "Draw small footprints with flour from entrance to puja room (Lakshmi's arrival)",
  ...
  },
  {
    ...
    rituals: [
      ...
      "Light 14 diyas in the home in the evening",
      "Worship Lord Krishna and Goddess Kali",
      "Burst crackers to celebrate defeat of Narakasura",
  ...
  },
  {
    ...
    rituals: [
      "Make a Govardhan hillock from cow dung or clay",
      "Decorate with flowers, diyas, and small Krishna idols",
      "Prepare 56 food items (Chappan Bhog) for offering",
      "Include all 6 tastes — sweet, sour, salty, bitter, pungent, astringent",
      "Circumambulate (parikrama) the Govardhan mound 7 times",
  ...
  },
  {
    ...
    rituals: [
      "Sister prepares a puja thali with roli, rice, diya, sweets, and coconut",
      "Apply tilak of roli + rice on brother's forehead",
      "Perform brother's aarti with the diya",
      "Feed brother a full meal — his favourite foods",
      "Brother gives a gift and touches sister's feet",
  ...
  },
  {
    ...
    days: [
      ...
      { day: "Day 3 - Tritiya", date: "October 11", desc: "Chandraghanta Puja — Deity who brings peace and prosperity." },
      { day: "Day 4 - Chaturthi", date: "October 12", desc: "Kushmanda Puja — Creator of the universe with her divine smile." },
      { day: "Day 5 - Panchami", date: "October 13", desc: "Skandamata Puja — Mother of Lord Kartikeya." },
      { day: "Day 6 - Shashthi", date: "October 14", desc: "Katyayani Puja — The warrior goddess born to sage Katyayana." },
      { day: "Day 7 - Saptami", date: "October 15", desc: "Kalaratri Puja — The fierce form. Most powerful night of Navratri." },
      { day: "Day 8 - Ashtami", date: "October 16", desc: "Mahagauri Puja — Kanya Puja. Feed 9 young girls as divine manifestations." },
      { day: "Day 9 - Navami", date: "October 17", desc: "Siddhidatri Puja — Havan and completion of vrat. Break fast." },
    ],
    muhurat: "Ghatasthapana Muhurat: October 9, 6:15 AM – 7:45 AM (IST)",
    rituals: [
      "Install Kalash (sacred pot) on Day 1 — Ghatasthapana",
      "Fast for 9 days or choose specific days",
      "Use only sendha namak (rock salt) in fasting food",
      "Light an akhand jyoti (continuous lamp) for all 9 days",
      "Read Durga Saptashati daily or listen to it",
  ...
  },
  {
    ...
    day: "Sunday",
    keywords: "ganesh chaturthi 2026 date, ganesh chaturthi kab hai 2026, vinayaka chaturthi 2026, ganpati festival 2026",
    shortDesc: "Ganesh Chaturthi 2026 falls on August 23rd (Sunday). The 10-day festival celebrating Lord Ganesha's birth.",
    description: "Ganesh Chaturthi 2026 falls on August 23rd (Sunday) on the Bhadrapada Shukla Chaturthi tithi. This 10-day festival celebrates the birth of Lord Ganesha, the remover of obstacles and the deity of wisdom and new beginnings. The festival culminates with Anant Chaturdashi (September 1, 2026), when Ganesha idols are immersed in water in a grand procession called Ganesh Visarjan.",
    days: [
      { day: "Day 1 - Sthapana", date: "August 23, 2026", desc: "Install Ganesha idol at home or in pandal. Perform Pranapratishtha (invocation of life). Begin 10-day worship." },
      { day: "Days 2-9", date: "August 24 – September 1", desc: "Daily puja morning and evening. Offer modak, durva grass, red flowers. Chant Ganesh Atharvashirsha." },
      { day: "Day 10 - Visarjan", date: "September 1, 2026", desc: "Anant Chaturdashi. Grand procession and immersion of Ganesha idol in water body. Ganpati Bappa Morya!" },
    ],
    muhurat: "Ganesh Sthapana Muhurat: 11:03 AM – 1:34 PM (IST)",
    rituals: [
      "Bring Ganesha idol home on Chaturthi morning",
      "Perform Shodashopachara (16-step) puja",
      "Offer 21 modaks — Ganesha's favourite",
      "Offer durva grass (3, 5, or 21 blades)",
      "Chant Ganesh Atharvashirsha 3 or 7 times daily",
      "Do NOT look at the moon on Chaturthi night",
      "Perform aarti twice daily — morning and evening",
      "Immerse idol on 1.5, 3, 5, 7, or 10th day"
    ],
    faq: [
      { q: "What is the date of Ganesh Chaturthi in 2026?", a: "Ganesh Chaturthi 2026 is on August 23rd (Sunday). The Chaturthi tithi begins on August 22nd evening." },
      { q: "Why should we not see the moon on Ganesh Chaturthi?", a: "According to the Bhagavata Purana, Lord Chandra (Moon) laughed at Ganesha's appearance. Ganesha cursed that whoever sees the moon on Chaturthi will be falsely accused. If accidentally seen, chant Syamantaka gem story from Bhagavatam as remedy." },
      { q: "How many days is Ganesh Chaturthi celebrated?", a: "The festival is celebrated for 10 days, ending on Anant Chaturdashi. Many families keep the idol for 1.5, 3, 5, 7, or all 10 days based on tradition." }
    ]
  },
  {
    slug: "ekadashi-calendar-2026",
    name: "Ekadashi Calendar 2026",
    icon: "🪷",
    date: "All 24 Ekadashi dates in 2026",
    tithi: "11th lunar day of each fortnight",
    day: "Varies",
    keywords: "ekadashi 2026 dates, ekadashi calendar 2026, all ekadashi dates 2026, ekadashi list 2026, ekadashi kab hai 2026",
    shortDesc: "Complete list of all 24 Ekadashi dates in 2026 with names and significance. Never miss an Ekadashi fast again.",
    description: "Ekadashi falls twice every month — on the 11th day of both the waxing (Shukla Paksha) and waning (Krishna Paksha) phases of the moon. In 2026, there are 24 Ekadashi fasts. Each Ekadashi has a unique name and special significance. Observing all Ekadashis in a year is said to grant moksha (liberation). Here is the complete Ekadashi calendar for 2026.",
    days: [
      { day: "Pausha Putrada Ekadashi", date: "January 1, 2026", desc: "Shukla Paksha. Blesses devotees with children and fulfills desires." },
      { day: "Shattila Ekadashi", date: "January 16, 2026", desc: "Krishna Paksha. Chanting and sesame offering destroys sins." },
      { day: "Jaya Ekadashi", date: "January 30, 2026", desc: "Shukla Paksha. Liberates from ghost and evil spirit afflictions." },
      { day: "Vijaya Ekadashi", date: "February 14, 2026", desc: "Krishna Paksha. Lord Rama observed this before Lanka war. Grants victory." },
      { day: "Amalaki Ekadashi", date: "March 2, 2026", desc: "Shukla Paksha. Worship of Amla (Indian gooseberry) tree. Gives moksha." },
      { day: "Papmochani Ekadashi", date: "March 16, 2026", desc: "Krishna Paksha. Destroys all sins committed knowingly or unknowingly." },
      { day: "Kamada Ekadashi", date: "March 31, 2026", desc: "Shukla Paksha (Chaitra). Fulfills all desires. Highly auspicious." },
      { day: "Varuthini Ekadashi", date: "April 15, 2026", desc: "Krishna Paksha. Fasting equivalent to donating gold and elephants." },
      { day: "Mohini Ekadashi", date: "April 29, 2026", desc: "Shukla Paksha (Vaishakha). Lord Vishnu appears as Mohini. Destroys illusion." },
      { day: "Apara Ekadashi", date: "May 15, 2026", desc: "Krishna Paksha. Removes sins of killing Brahmins, cows, and false accusations." },
      { day: "Nirjala Ekadashi", date: "May 29, 2026", desc: "Shukla Paksha (Jyeshtha). Strictest Ekadashi — no water. Equivalent to all 24 Ekadashis." },
      { day: "Yogini Ekadashi", date: "June 13, 2026", desc: "Krishna Paksha. Cures diseases and liberates from sins." },
      { day: "Devshayani Ekadashi", date: "June 27, 2026", desc: "Shukla Paksha (Ashadha). Lord Vishnu begins 4-month sleep (Chaturmas)." },
      { day: "Kamika Ekadashi", date: "July 13, 2026", desc: "Krishna Paksha. Worship with Tulsi. Removes all sins." },
      { day: "Shravana Putrada Ekadashi", date: "July 27, 2026", desc: "Shukla Paksha. Blesses childless couples with offspring." },
      { day: "Aja Ekadashi", date: "August 11, 2026", desc: "Krishna Paksha. Destroys sins of past and present life." },
      { day: "Parivartini Ekadashi", date: "August 26, 2026", desc: "Shukla Paksha. Lord Vishnu turns sides during his cosmic sleep." },
      { day: "Indira Ekadashi", date: "September 9, 2026", desc: "Krishna Paksha. Liberates ancestors from hell." },
      { day: "Papankusha Ekadashi", date: "September 24, 2026", desc: "Shukla Paksha (Ashwin). Equal to donating gold, land, and cows." },
      { day: "Rama Ekadashi", date: "October 9, 2026", desc: "Krishna Paksha. Destroys all sins. Lord Vishnu grants moksha." },
      { day: "Devutthana Ekadashi", date: "October 23, 2026", desc: "Shukla Paksha. Lord Vishnu awakens from 4-month sleep. Marriage season begins." },
      { day: "Utpanna Ekadashi", date: "November 7, 2026", desc: "Krishna Paksha. Birth of Ekadashi goddess from Vishnu's body." },
      { day: "Mokshada Ekadashi", date: "November 22, 2026", desc: "Shukla Paksha (Margashirsha). Gita Jayanti. Grants moksha to ancestors." },
      { day: "Saphala Ekadashi", date: "December 7, 2026", desc: "Krishna Paksha. Makes all efforts successful." },
    ],
    muhurat: "Each Ekadashi: Fast from sunrise, break on Dwadashi after Parana time",
    rituals: [
      "Fast from grain, pulses, and cereals",
      "Eat only fruits, milk, nuts, and sago",
      "Chant Om Namo Bhagavate Vasudevaya 108 times",
      "Visit Vishnu temple if possible",
      "Stay awake through Ekadashi night (jagran) for extra merit",
      "Break fast on Dwadashi within Parana window",
      "Donate food or grains on Dwadashi morning"
    ],
    faq: [
      { q: "How many Ekadashi are there in 2026?", a: "There are 24 Ekadashi fasts in 2026 — two per month, one each in Shukla Paksha (waxing moon) and Krishna Paksha (waning moon)." },
      { q: "Which is the most important Ekadashi in 2026?", a: "Nirjala Ekadashi (May 29, 2026) is considered the most powerful. Observing it with no water is said to be equivalent to observing all 24 Ekadashis." },
      { q: "What time should I break Ekadashi fast (Parana)?", a: "Parana is done on Dwadashi (12th day) after sunrise, within a specific time window. The window is typically 1.5 to 3 hours after sunrise. Check your local panchangam for exact timing." }
    ]
  },
  {
    slug: "hindu-festival-calendar-2026",
    name: "Hindu Festival Calendar 2026",
    icon: "📅",
    date: "Complete year 2026",
    tithi: "All major Hindu festivals",
    day: "Full year",
    ...
    days: [
      ...
      { day: "Maha Shivratri", date: "February 18, 2026", desc: "Greatest night of Shiva. All-night vigil, Shiva abhishek, Nirjala fast." },
      { day: "Holi", date: "March 3, 2026", desc: "Festival of colours. Holika Dahan on March 2nd evening." },
      { day: "Ugadi / Gudi Padwa", date: "March 20, 2026", desc: "Hindu New Year (Vikram Samvat). New year for Maharashtra, Andhra, Karnataka." },
      { day: "Ram Navami", date: "March 29, 2026", desc: "Lord Rama's birthday. Fast, recite Ramcharitmanas, visit temples." },
      { day: "Hanuman Jayanti", date: "April 12, 2026", desc: "Hanuman's birthday. Recite Hanuman Chalisa, offer sindoor." },
      { day: "Akshaya Tritiya", date: "April 20, 2026", desc: "Extremely auspicious day. Buy gold. Start new ventures. No bad muhurat." },
      { day: "Guru Purnima", date: "July 7, 2026", desc: "Full moon of Ashadha. Honor your Guru and teachers." },
      { day: "Raksha Bandhan", date: "August 9, 2026", desc: "Sisters tie rakhi on brothers' wrists. Celebrate sibling bond." },
      { day: "Janmashtami", date: "August 16, 2026", desc: "Lord Krishna's birthday. Midnight celebration, Dahi Handi, fast." },
    ...
    rituals: [
      "Mark all dates in your calendar at the start of the year",
      "Plan leave from work for major festivals",
      "Order puja samagri in advance for big festivals",
      "Connect with family for collective celebrations",
...
export type Festival = typeof festivals[0];