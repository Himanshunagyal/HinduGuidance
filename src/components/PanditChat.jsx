...
const SUGGESTED_QUESTIONS = [
  ...
  "What is the best muhurat for marriage in 2025?",
      ...
      <div className="card-sacred rounded-sm overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-darkbrown to-deepred p-4 flex items-center gap-3">
          ...
          <div className="text-right hidden sm:block">
            <p className="text-gold/60 text-xs font-sans tracking-widest">ॐ</p>
            <p className="text-cream/40 text-xs font-sans">Dharmo Rakshati</p>
          </div>
        </div>
        ...
        <div className="h-[480px] overflow-y-auto p-5 space-y-4 bg-gradient-to-b from-cream/80 to-cream">
          {messages.map((msg, i) => (
            ...
            >
              ...
              <div
                className={`max-w-[80%] p-4 rounded-sm text-sm font-body leading-relaxed whitespace-pre-wrap ${
                  msg.role === 'assistant' 
        ...
        <div className="p-4 border-t border-gold/20 bg-white/50">
          <div className="flex gap-3">
            <input
              ...
              placeholder="Ask Panditji about vrats, puja, muhurat..."
              disabled={loading}
